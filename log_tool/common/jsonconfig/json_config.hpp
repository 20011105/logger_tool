...
#define DEFAULT_LOWER_DEVICE_LOGGER_PORT    15201   //下位机日至端口/默认
#define DEFAULT_LOWER_DEVICE_REMOTE_PORT    15202   //下位机远程控制端口
...
#define DEFAULT_DOWNLOAD_PATH       "/tmp/download/"    //默认下载路径
#define DEFAULT_NODE_PORT           8000
#define DEFAULT_LOWER_DEVICE_PORT   8001    //下位机设备端口
...
public:
    ...
    const DeviceSysConfig &get_icm_config()     const   {return parameter_.local_device.icm_spi;}//所有驱动的配置，，从系统配置值中获取
...
private:
    ...
    //该路径的值可以修改system_config::init(const char* path)中的path更新
